...
<p>You must be logged in to post a comment.<br>
               <a href="http://localhost/jedcore/wp-login.php?loginFacebook=1&redirect=http://localhost/jedcore" onclick="window.location = 'http:localhost/jedcore/wp-login.php?loginFacebook=1&redirect='+window.location.href; return false;">
               <img src="<?php bloginfo('template_url');?>/images/fb/fb-button.png" class="fb-login-button img-fluid">
                </a>
</p>
<?php else : ?>
...
<p><input name="submit" class="btn btn-info-outline" type="submit" id="submit" tabindex="5" value="Post" />
